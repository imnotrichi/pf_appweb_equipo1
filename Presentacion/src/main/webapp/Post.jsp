    ...
    <div class="contenedor">
        <aside>
            <nav>
                <div class="secciones">
                    <ul>
                        <li><a href="Inicio2.html"><img src="./imagenes/white-home-icon.png" alt="">Inicio</a></li>
                        ...
                        <li><a href="Noticias.html"><img src="./imagenes/white-news-icon.png" alt="">Noticias</a></li>
                ...
                <div class="iniciar-sesion">
                    <a href="IniciarRegistrar.html">Cerrar Sesión</a>
                </div>
            </nav>
        </aside>
        ...
        <main>
            <section>
                <article class="post">
                    ...
                    <div>
                        <h2 class="usuario-fecha">@pipucate - <span>10/10/2024</span></h2>
                    </div>
                    <h1>Taylor Swift tu patrona</h1>
                    <h2>Les estaré mostrando porque Taylor Swift es una de las mejores cantantes...</h2>

                    <p>Lorem ipsum Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis ut rem est earum
                        quod accusamus odit soluta debitis assumenda iure. Facilis officiis repellendus voluptates
                        doloribus. Repellat natus laboriosam veritatis velit. lorem Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Eos, eligendi. Dolorum accusantium quasi beatae. A quis quod,
                        reprehenderit quidem explicabo iusto vitae ea mollitia fugiat tenetur facere totam illo
                        laudantium. Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates vero quae ea
                        veniam nobis incidunt officia placeat! Explicabo sapiente aspernatur aliquid, blanditiis odit
                        aut doloremque voluptatibus ipsam qui ipsa reprehenderit!dolor, sit amet consectetur adipisicing
                        elit. Cumque ab architecto officiis iste, sapiente maiores corrupti esse aliquam qui, id libero
                        ipsa ducimus quo saepe ea quidem modi eaque at!</p>
                    <p>Lorem ipsum Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis ut rem est earum
                        quod accusamus odit soluta debitis assumenda iure. Facilis officiis repellendus voluptates
                        doloribus. Repellat natus laboriosam veritatis velit. lorem Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Eos, eligendi. Dolorum accusantium quasi beatae. A quis quod,
